        ...
        <div class="mySlides fade">
            <div class="numbertext">1 / 3</div>
                <a target="_blank" href="images/hot01.jpg">
                    <img src="images/hot01.jpg" style="width:100%">
                </a>
            <div class="text"><em>Main elevation</em></div>
        </div>
        <div class="mySlides fade">
            <div class="numbertext">2 / 3</div>
                <a target="_blank" href="images/hot02.jpg">
                    <img src="images/hot02.jpg" style="width:100%">
                </a>
            <div class="text"><em>Structure Axo | Plans | Sections</em></div>
        </div>
        <div class="mySlides fade">
            <div class="numbertext">3 / 3</div>
                <a target="_blank" href="images/hot03.jpg">    
                    <img src="images/hot03.jpg" style="width:100%">
                </a>
            <div class="text"><em>Construction details</em></div>
        </div>
